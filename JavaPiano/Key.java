...
public class Key {
	...
	public void paint (Graphics g) {
		...
		if(_color == Color.WHITE) g.setColor(Color.BLACK); // Only white keys get the Black outline, doesn't matter
															// that much but I added it just in case
	...
	/**
	 * Checks if the key is turned on or not
	 */
	public boolean isOn() {
		return _isOn;
	}
