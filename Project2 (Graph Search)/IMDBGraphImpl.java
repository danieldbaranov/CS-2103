...
public class IMDBGraphImpl implements IMDBGraph {
	...
	public static final String IMDB_DIRECTORY = "C:/Users/Daniel/Documents/JavaIMDB";
	...
	private static class IMDBNode implements Node {
		...
		public void addNeighbor(IMDBNode movie){
	 ...
	 */
	public IMDBNode getMovie (String name) {
	 ...
	 */
	public IMDBNode getActor (String name) {
			...
			if (fields.length >= NUM_REQUIRED_FIELDS) {
				...
				if (profession.contains("actor") || profession.contains("actress")) {
					...
					for(String movie: knownFor){
						actorNode.addNeighbor(getMovie(idsToTitles.get(movie)));
						if(getMovie(idsToTitles.get(movie)) != null){
							getMovie(idsToTitles.get(movie)).addNeighbor(actorNode);
						}
